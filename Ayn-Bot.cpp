        ...
        if(password=="1234")
        {
            ...
            do{
                ...
                else if(command=="open pdf")
                {
                    ...
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);("C:\\Users\\shank\\Documents\\aynbot\\The Great Partition The Making of India and Pakistan, New Edition. by Yasmin Khan (z-lib.org).pdf",NULL, NULL, SW_NORMAL);
                }
